"""Iris 3.0 — Hardware PnP Device Scanner for Interception Keyboard Slots (1..10).
...
log = logging.getLogger("device_scanner")
...
def scan_devices(interception_dll, context) -> List[DeviceInfo]:
    ...
    try:
        ...
        log.warning("[device_scanner] scan_devices failed: %s", ex)
        return []
